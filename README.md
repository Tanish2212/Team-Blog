# Dynamic Multi-Agent RAG with Pathway
...
- <span style="color:blue">**Integration with Pathway**</span>: We have extended the `BaseEmbedded` class to incorporate Jina Embeddings using API calls.  
...
- <span style="color:blue">**Integration with Pathway**</span> : Integration with Pathway requires metadata-level filtering to enable structured retrieval across hierarchical clusters.  
...
#### <span style="color:blue">**Integration with Pathway**</span>
